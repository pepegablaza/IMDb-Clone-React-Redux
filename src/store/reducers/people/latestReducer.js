...
const latestReducer = (state = initialState, action) => {
  switch (action.type) {
    case fetchActionTypes.START_FETCHING_ + peopleActionTypes.LATEST_PEOPLE:
      return { ...state, loading: action.payload };
    case fetchActionTypes.SUCCESS_FETCHING_ + peopleActionTypes.LATEST_PEOPLE:
      return {
        ...state,
        loading: action.payload.loading,
        data: action.payload.data,
      };
    case fetchActionTypes.FAILED_FETCHING_ + peopleActionTypes.LATEST_PEOPLE:
      return {
        ...state,
